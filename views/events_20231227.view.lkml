# The name of this view in Looker is "Events 20231227"
view: events_20231227 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `analytics_410720616.events_20231227` ;;
...
# The name of this view in Looker is "Events 20231227 Items"
view: events_20231227__items {
  ...
  dimension: events_20231227__items {
    type: string
    hidden: yes
    sql: events_20231227__items ;;
  }
...
# The name of this view in Looker is "Events 20231227 Event Params"
view: events_20231227__event_params {
  ...
  dimension: events_20231227__event_params {
    type: string
    hidden: yes
    sql: events_20231227__event_params ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
...
# The name of this view in Looker is "Events 20231227 User Properties"
view: events_20231227__user_properties {
  ...
  dimension: events_20231227__user_properties {
    type: string
    hidden: yes
    sql: events_20231227__user_properties ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Key" in Explore.
...
# The name of this view in Looker is "Events 20231227 Items Item Params"
view: events_20231227__items__item_params {
